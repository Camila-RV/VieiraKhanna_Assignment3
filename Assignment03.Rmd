...
Hypothesis: The energy imports indicator may allows us to verify whether countries have reduced dependence on energy sources from other countries by producing more electricity through its own sources.
We expect that a lower energy imports value increases the likelihood of countries to be using electricity generated locally via wind and solar energy sources. /// If a country presents a negative value it indicates that the country is a net exporter./////
